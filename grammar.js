...
module.exports = grammar({
    ...
    rules: {
        ...
        _interface_item: ($) =>
            choice($.interface_type_item, $.fun_sig),
        ...
        impl_block: ($) =>
            seq(
                ...
                optional($._template_params),
                optional(
                    seq(field("interface", $._type_expr), "for"),
                ),
        ...
        if_stmt: ($) =>
            seq(
                ...
                optional(
                    seq(
                        "else",
                        field("else", choice($.block, $.if_stmt)),
                    ),
                ),
            ),
